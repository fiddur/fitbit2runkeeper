...
module.exports = ({ rp, config, onNewTokens }) => {
  ...
  return {
    getActivities: (user, date) => fbRp(user, new Immutable.Map({
      json: true,
      uri:  `https://api.fitbit.com/1/user/-/activities/list.json?beforeDate=${date.format('YYYY-MM-DD')}&sort=desc&limit=10&offset=0`,
